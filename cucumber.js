module.exports = {
	...
	"chrome-phone-test-martin": "--tags @phone,@Martin --world-parameters " + JSON.stringify({ platform: "chrome-phone-test", width: 520, height: 920 }),
	"chrome-tablet-test-martin": "--tags @tablet,@Martin --world-parameters " + JSON.stringify({ platform: "chrome-phone-test", width: 520, height: 920 }),
