...
class TaskList extends PageObject {
	...
	async wasteRecoveryPlanCompleted() {
		return this.browser.wait(until.elementLocated(By.id("waste-recovery-plan-completed")), 5 * 20000);
	}

	async saveApplicationCompleted() {
		return this.browser.wait(until.elementLocated(By.id("set-up-save-and-return-completed")), 5 * 20000);
	}
	...
	async wasteRecoveryPlanLink() {
		return this.browser.wait(until.elementLocated(By.id("waste-recovery-plan-link")), 5 * 20000);
	}
