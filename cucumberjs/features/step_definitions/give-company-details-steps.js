...
module.exports = function () {
    ...
    this.defineStep(/^the Company number should be "(.*?)"$/, { timeout: 2000000 }, async function (companyNo) {
    ...
    this.defineStep(/^I should be able to see "(.*?)" link$/, { timeout: 2000000 }, async function (option) {
        switch (option) {
    ...
    this.defineStep(/^I click on "(.*?)" link$/, { timeout: 2000000 }, async function (option) {
        switch (option) {
            case "Enter a different number":
    ...
    this.defineStep(/^the Company name should be "(.*?)"$/, { timeout: 2000000 }, async function (companyNo) {
    ...
    this.defineStep(/^the Company address should be "(.*?)"$/, { timeout: 2000000 }, async function (companyNo) {
    ...
    this.defineStep(/^I should be able to see "([^"]*)" field$/, { timeout: 2000000 }, async function (button) {
        switch (button) {
    ...
    this.defineStep(/^I click on "([^"]*)" field$/, { timeout: 2000000 }, async function (button) {
        switch (button) {
            case "We use a different trading name":
    ...
    this.defineStep(/^the director "([^"]*)" name should be "([^"]*)"$/, { timeout: 2000000 }, async function (no, directorName) {
    ...
    this.defineStep(/^the director "([^"]*)" month and year of birth should be "([^"]*)"$/, { timeout: 2000000 }, async function (no, monthYearBirth) {
    ...
    this.defineStep(/^I enter "([^"]*)" in the day field of the director "([^"]*)" birthdate$/, { timeout: 2000000 }, async function (birthDay,no) {
    ...
    this.defineStep(/^I select "([^"]*)" option$/, { timeout: 2000000 }, async function (option) {
        switch (option) {
            case "Yes":
    ...
    this.defineStep(/^Declaration text area should be displayed$/, { timeout: 2000000 }, async function () {
        await this.giveCompanyDetails.declaredTextField();
    });
    //     When I enter "My declaration" in the "Declaration" text
    this.defineStep(/^I enter "([^"]*)" in the Declaration text$/, { timeout: 2000000 }, async function (text) {
