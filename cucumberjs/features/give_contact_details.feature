Feature: WE-745 GIVE CONTACT DETAILS PAGE
    ...
    Scenario: As a user, I should be able get error message for incorrect contact details
        ...
        And I click on "Continue" button
        Then I am on the "Who should we contact about this application?" page
        And I should be able to see text:"A problem to fix"
        And I should be able to see text:"Enter a first name"
        And I should be able to see text:"Enter a last name"
        And I should be able to see text:"Enter a telephone number"
        And I should be able to see text:"Enter an email address for the main contact"
        When I enter "TestUser" in the "First name" field
        And I click on "Continue" button
        Then I should be able to see text:"A problem to fix"
        And I should not be able to see text:"Enter a first name"
        And I should be able to see text:"Enter a last name"
        And I should be able to see text:"Enter a telephone number"
        And I should be able to see text:"Enter an email address for the main contact"
        ...
        Then I should be able to see text:"A problem to fix"
        And I should not be able to see text:"Enter a first name"
        And I should not be able to see text:"Enter a last name"
        And I should be able to see text:"Enter a telephone number"
        And I should be able to see text:"Enter an email address for the main contact"
        And I enter "07777777777" in the "Telephone number" field
        And I click on "Continue" button
        ...
        And I should not be able to see text:"Enter a first name"
        And I should not be able to see text:"Enter a last name"
        And I should not be able to see text:"Enter a telephone number"
        And I should be able to see text:"Enter an email address for the main contact"
